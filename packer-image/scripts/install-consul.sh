...
# HACK: sub cli for metadata api
function install_hack_metadata_dependencies {
  log_info "Installing hack metadata dependencies"
...
function install {
  ...
  # HACK: sub cli for metadata api
  install_hack_metadata_dependencies
